...
You create an acidic bubble at a point within range, where it explodes in a 5-foot-radius [Sphere](Compendium/rules/variant-rules/sphere-area-of-effect-xphb.md). Each creature in that [Sphere](Compendium/rules/variant-rules/sphere-area-of-effect-xphb.md) must succeed on a Dexterity saving throw or take `1d6` Acid damage.
