...
You place a curse on a creature that you can see within range. Until the spell ends, you deal an extra `1d6` Necrotic damage to the target whenever you hit it with an attack roll. Also, choose one ability when you cast the spell. The target has [[disadvantage-xphb]] on ability checks made with the chosen ability.

If the target drops to 0 [[hit-points-xphb]] before this spell ends, you can take a [[bonus-action-xphb]] on a later turn to curse a new creature.
...
**Classes**: [Warlock (Great Old One Patron)](Compendium/lists/list-spells-classes-great-old-one-patron-xphb.md "subclass=XPHB;class=XPHB"); [[list-spells-classes-warlock]]
