...
The wall, which has AC 10, can be destroyed one layer at a time, in order from red to violet, by means specific to each layer. If a layer is destroyed, it is gone for the duration. [[Antimagic Field]] has no effect on the wall, and [[dispel-magic-xphb]] can affect only the violet layer.
...
| 6 | **Indigo.** *Failed Save:* The target has the [Restrained](Compendium/rules/conditions.md#Restrained) condition and makes a Constitution saving throw at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it has the [Petrified](Compendium/rules/conditions.md#Petrified) condition until it is freed by an effect like the [[greater-restoration-xphb]] spell. The successes and failures needn't be consecutive; keep track of both until the target collects three of a kind. *Additional Effects:* Spells can't be cast through this layer, which is destroyed by [[Bright Light]] shed by the [[daylight-xphb]] spell. |
