...
You magically mark one creature you can see within range as your quarry. Until the spell ends, you deal an extra `1d6` Force damage to the target whenever you hit it with an attack roll. You also have [[advantage-xphb]] on any Wisdom ([Perception](Compendium/rules/skills.md#Perception) or [Survival](Compendium/rules/skills.md#Survival)) check you make to find it.

If the target drops to 0 [[hit-points-xphb]] before this spell ends, you can take a [[bonus-action-xphb]] to move the mark to a new creature you can see within range.
