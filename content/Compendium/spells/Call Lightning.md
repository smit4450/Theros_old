...
A storm cloud appears at a point within range that you can see above yourself. It takes the shape of a [[Cylinder (Area of Effect)]] that is 10 feet tall with a 60-foot radius.
...
Until the spell ends, you can take a [Magic](Compendium/rules/act[Magic](Actions.md#Magic)ng in that way again, targeting the same point or a different one.
...
**Classes**: [Bard (College of Lore)](Spells%20for%20College%20of%20Lore.md "subclass=XPHB;class=XPHB"); [[Bard Spells]]; [[Druid Spells]]
