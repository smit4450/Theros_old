...
When the familiar drops to 0 [[Hit Points]], it disappears. It reappears after you cast this spell again. As a [Magic](Compendium/rules/ac[Magic](Actions.md#Magic)y dismiss the familiar to a pocket dimension. Alternatively, you can dismiss it forever. As a [Magic](Compendium/rules/ac[Magic](Actions.md#Magic)rily dismissed, you can cause it to reappear in an unoccupied space within 30 feet of you. Whenever the familiar drops to 0 [[Hit Points]] or disappears into the pocket dimension, it leaves behind in its space anything it was wearing or carrying.
...
**Classes**: [Bard (College of Lore)](Spells%20for%20College%20of%20Lore.md "subclass=XPHB;class=XPHB"); [[Bard Spells]]; [[Druid Spells]]; [Fighter (Eldritch Knight)](Spells%20for%20Eldritch%20Knight.md "subclass=XPHB;class=XPHB"); [Rogue (Arcane Trickster)](Spells%20for%20Arcane%20Trickster.md "subclass=XPHB;class=XPHB"); [[Wizard Spells]]
