...
You shape-shift into another creature for the duration or until you take a [Magic](Compendium/rules/[Magic](Actions.md#Magic)to a different eligible form. The new form must be of a creature that has a [[Challenge Rating]] no higher than your level or [[Challenge Rating]]. You must have seen the sort of creature before, and it can't be a Construct or an Undead.
