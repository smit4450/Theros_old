...
A flickering flame appears in your hand and remains there for the duration. While there, the flame emits no heat and ignites nothing, and it sheds [Bright Light](Compendium/rules/variant-rules/bright-light-xphb.md) in a 20-foot radius and [Dim Light](Compendium/rules/variant-rules/dim-light-xphb.md) for an additional 20 feet. The spell ends if you cast it again.
