...
A silvery beam of pale light shines down in a 5-foot-radius, 40-foot-high [[cylinder-area-of-effect-xphb]] centered on a point within range. Until the spell ends, [[dim-light-xphb]] fills the [[cylinder-area-of-effect-xphb]], and you can take a [Magic](Compendium/rules/actions.md#Magic) action on later turns to move the [[cylinder-area-of-effect-xphb]] up to 60 feet.

When the [[cylinder-area-of-effect-xphb]] appears, each creature in it makes a Constitution saving throw. On a failed save, a creature takes `2d10` Radiant damage, and if the creature is shape-shifted (as a result of the [[polymorph-xphb]] spell, for example), it reverts to its true form and can't shape-shift until it leaves the [[cylinder-area-of-effect-xphb]]. On a successful save, a creature takes half as much damage only. A creature also makes this save when the spell's area moves into its space and when it enters the spell's area or ends its turn there. A creature makes this save only once per turn.
