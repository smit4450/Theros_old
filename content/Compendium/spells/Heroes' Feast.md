...
A creature that partakes gains several benefits, which last for 24 hours. The creature has [[Compendium/spells/Resistance]] to Poison damage, and it has [[Immunity]] to the [Frightened](Conditions.md#Frightened) and [Poisoned](Conditions.md#Poisoned) conditions. Its [[Hit Points]] maximum also increases by `2d10`, and it gains the same number of [[Hit Points]].
