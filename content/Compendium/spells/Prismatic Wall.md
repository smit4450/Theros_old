...
| 6 | **Indigo.** *Failed Save:* The target has the [Restrained](Conditions.md#Restrained) condition and makes a Constitution saving throw at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it has the [Petrified](Conditions.md#Petrified) condition until it is freed by an effect like the [[Greater Restoration]] spell. The successes and failures needn't be consecutive; keep track of both until the target collects three of a kind. *Additional Effects:* Spells can't be cast through this layer, which is destroyed by [[Bright Light]] shed by the [[Daylight]] spell. |
