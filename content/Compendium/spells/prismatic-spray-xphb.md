...
| 6 | **Indigo.** *Failed Save:* The target has the [Restrained](Compendium/rules/conditions.md#Restrained) condition and makes a Constitution saving throw at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it has the [Petrified](Compendium/rules/conditions.md#Petrified) condition until it is freed by an effect like the [[greater-restoration-xphb]] spell. The successes and failures needn't be consecutive; keep track of both until the target collects three of a kind. |
