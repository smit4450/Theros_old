...
Your touch inflicts a magical contagion. The target must succeed on a Constitution saving throw or take `11d8` Necrotic damage and have the [Poisoned](Compendium/rules/conditions.md#Poisoned) condition. Also, choose one ability when you cast the spell. While [Poisoned](Compendium/rules/conditions.md#Poisoned), the target has [[disadvantage-xphb]] on saving throws made with the chosen ability.
