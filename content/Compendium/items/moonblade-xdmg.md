...
| 100 | You can take a [Magic](Compendium/rules/actions.md#Magic) action to conjure a spectral entity that resembles a shadowy elf if you don't already have one serving you. The entity appears in an unoccupied space within 120 feet of you. It uses the [[Shadow]] stat block with these changes: it is a Fey, has a Neutral alignment, and doesn't create new shadows. You control this entity, deciding how it acts and moves. It remains until it drops to 0 [[hit-points-xphb]] or you dismiss it as a [Magic](Compendium/rules/actions.md#Magic) action. |
^moonblade-properties
