...
**Variants**:
- [[#Enspelled (Level 3|Enspelled (Level 3) Antimatter Rifle]] Antimatter Rifle)
- [[#Enspelled (Level 3|Enspelled (Level 3) Automatic Rifle]] Automatic Rifle)
- [[#Enspelled (Level 3|Enspelled (Level 3) Battleaxe]] Battleaxe)
- [[#Enspelled (Level 3|Enspelled (Level 3) Blowgun]] Blowgun)
- [[#Enspelled (Level 3|Enspelled (Level 3) Club]] Club)
- [[#Enspelled (Level 3|Enspelled (Level 3) Dagger]] Dagger)
- [[#Enspelled (Level 3|Enspelled (Level 3) Dart]] Dart)
- [[#Enspelled (Level 3|Enspelled (Level 3) Double-Bladed Scimitar]] Double-Bladed Scimitar)
- [[#Enspelled (Level 3|Enspelled (Level 3) Flail]] Flail)
- [[#Enspelled (Level 3|Enspelled (Level 3) Glaive]] Glaive)
- [[#Enspelled (Level 3|Enspelled (Level 3) Greataxe]] Greataxe)
- [[#Enspelled (Level 3|Enspelled (Level 3) Greatclub]] Greatclub)
- [[#Enspelled (Level 3|Enspelled (Level 3) Greatsword]] Greatsword)
- [[#Enspelled (Level 3|Enspelled (Level 3) Halberd]] Halberd)
- [[#Enspelled (Level 3|Enspelled (Level 3) Hand Crossbow]] Hand Crossbow)
- [[#Enspelled (Level 3|Enspelled (Level 3) Handaxe]] Handaxe)
- [[#Enspelled (Level 3|Enspelled (Level 3) Heavy Crossbow]] Heavy Crossbow)
- [[#Enspelled (Level 3|Enspelled (Level 3) Hooked Shortspear]] Hooked Shortspear)
- [[#Enspelled (Level 3|Enspelled (Level 3) Hoopak]] Hoopak)
- [[#Enspelled (Level 3|Enspelled (Level 3) Hunting Rifle]] Hunting Rifle)
- [[#Enspelled (Level 3|Enspelled (Level 3) Javelin]] Javelin)
- [[#Enspelled (Level 3|Enspelled (Level 3) Lance]] Lance)
- [[#Enspelled (Level 3|Enspelled (Level 3) Laser Pistol]] Laser Pistol)
- [[#Enspelled (Level 3|Enspelled (Level 3) Laser Rifle]] Laser Rifle)
- [[#Enspelled (Level 3|Enspelled (Level 3) Light Crossbow]] Light Crossbow)
- [[#Enspelled (Level 3|Enspelled (Level 3) Light Hammer]] Light Hammer)
- [[#Enspelled (Level 3|Enspelled (Level 3) Light Repeating Crossbow]] Light Repeating Crossbow)
- [[#Enspelled (Level 3|Enspelled (Level 3) Longbow]] Longbow)
- [[#Enspelled (Level 3|Enspelled (Level 3) Longsword]] Longsword)
- [[#Enspelled (Level 3|Enspelled (Level 3) Mace]] Mace)
- [[#Enspelled (Level 3|Enspelled (Level 3) Maul]] Maul)
- [[#Enspelled (Level 3|Enspelled (Level 3) Morningstar]] Morningstar)
- [[#Enspelled (Level 3|Enspelled (Level 3) Musket]] Musket)
- [[#Enspelled (Level 3|Enspelled (Level 3) Pike]] Pike)
- [[#Enspelled (Level 3|Enspelled (Level 3) Pistol]] Pistol)
- [[#Enspelled (Level 3|Enspelled (Level 3) Quarterstaff]] Quarterstaff)
- [[#Enspelled (Level 3|Enspelled (Level 3) Rapier]] Rapier)
- [[#Enspelled (Level 3|Enspelled (Level 3) Revolver]] Revolver)
- [[#Enspelled (Level 3|Enspelled (Level 3) Scimitar]] Scimitar)
- [[#Enspelled (Level 3|Enspelled (Level 3) Semiautomatic Pistol]] Semiautomatic Pistol)
- [[#Enspelled (Level 3|Enspelled (Level 3) Shortbow]] Shortbow)
- [[#Enspelled (Level 3|Enspelled (Level 3) Shortsword]] Shortsword)
- [[#Enspelled (Level 3|Enspelled (Level 3) Shotgun]] Shotgun)
- [[#Enspelled (Level 3|Enspelled (Level 3) Sickle]] Sickle)
- [[#Enspelled (Level 3|Enspelled (Level 3) Sling]] Sling)
- [[#Enspelled (Level 3|Enspelled (Level 3) Spear]] Spear)
- [[#Enspelled (Level 3|Enspelled (Level 3) Staff]] Staff)
- [[#Enspelled (Level 3|Enspelled (Level 3) Trident]] Trident)
- [[#Enspelled (Level 3|Enspelled (Level 3) War Pick]] War Pick)
- [[#Enspelled (Level 3|Enspelled (Level 3) Warhammer]] Warhammer)
- [[#Enspelled (Level 3|Enspelled (Level 3) Whip]] Whip)
- [[#Enspelled (Level 3|Enspelled (Level 3) Wooden Staff]] Wooden Staff)
- [[#Enspelled (Level 3|Enspelled (Level 3) Yklwa]] Yklwa)
