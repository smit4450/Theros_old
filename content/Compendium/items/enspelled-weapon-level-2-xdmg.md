...
**Variants**:
- [[#Enspelled (Level 2|Enspelled (Level 2) Antimatter Rifle]] Antimatter Rifle)
- [[#Enspelled (Level 2|Enspelled (Level 2) Automatic Rifle]] Automatic Rifle)
- [[#Enspelled (Level 2|Enspelled (Level 2) Battleaxe]] Battleaxe)
- [[#Enspelled (Level 2|Enspelled (Level 2) Blowgun]] Blowgun)
- [[#Enspelled (Level 2|Enspelled (Level 2) Club]] Club)
- [[#Enspelled (Level 2|Enspelled (Level 2) Dagger]] Dagger)
- [[#Enspelled (Level 2|Enspelled (Level 2) Dart]] Dart)
- [[#Enspelled (Level 2|Enspelled (Level 2) Double-Bladed Scimitar]] Double-Bladed Scimitar)
- [[#Enspelled (Level 2|Enspelled (Level 2) Flail]] Flail)
- [[#Enspelled (Level 2|Enspelled (Level 2) Glaive]] Glaive)
- [[#Enspelled (Level 2|Enspelled (Level 2) Greataxe]] Greataxe)
- [[#Enspelled (Level 2|Enspelled (Level 2) Greatclub]] Greatclub)
- [[#Enspelled (Level 2|Enspelled (Level 2) Greatsword]] Greatsword)
- [[#Enspelled (Level 2|Enspelled (Level 2) Halberd]] Halberd)
- [[#Enspelled (Level 2|Enspelled (Level 2) Hand Crossbow]] Hand Crossbow)
- [[#Enspelled (Level 2|Enspelled (Level 2) Handaxe]] Handaxe)
- [[#Enspelled (Level 2|Enspelled (Level 2) Heavy Crossbow]] Heavy Crossbow)
- [[#Enspelled (Level 2|Enspelled (Level 2) Hooked Shortspear]] Hooked Shortspear)
- [[#Enspelled (Level 2|Enspelled (Level 2) Hoopak]] Hoopak)
- [[#Enspelled (Level 2|Enspelled (Level 2) Hunting Rifle]] Hunting Rifle)
- [[#Enspelled (Level 2|Enspelled (Level 2) Javelin]] Javelin)
- [[#Enspelled (Level 2|Enspelled (Level 2) Lance]] Lance)
- [[#Enspelled (Level 2|Enspelled (Level 2) Laser Pistol]] Laser Pistol)
- [[#Enspelled (Level 2|Enspelled (Level 2) Laser Rifle]] Laser Rifle)
- [[#Enspelled (Level 2|Enspelled (Level 2) Light Crossbow]] Light Crossbow)
- [[#Enspelled (Level 2|Enspelled (Level 2) Light Hammer]] Light Hammer)
- [[#Enspelled (Level 2|Enspelled (Level 2) Light Repeating Crossbow]] Light Repeating Crossbow)
- [[#Enspelled (Level 2|Enspelled (Level 2) Longbow]] Longbow)
- [[#Enspelled (Level 2|Enspelled (Level 2) Longsword]] Longsword)
- [[#Enspelled (Level 2|Enspelled (Level 2) Mace]] Mace)
- [[#Enspelled (Level 2|Enspelled (Level 2) Maul]] Maul)
- [[#Enspelled (Level 2|Enspelled (Level 2) Morningstar]] Morningstar)
- [[#Enspelled (Level 2|Enspelled (Level 2) Musket]] Musket)
- [[#Enspelled (Level 2|Enspelled (Level 2) Pike]] Pike)
- [[#Enspelled (Level 2|Enspelled (Level 2) Pistol]] Pistol)
- [[#Enspelled (Level 2|Enspelled (Level 2) Quarterstaff]] Quarterstaff)
- [[#Enspelled (Level 2|Enspelled (Level 2) Rapier]] Rapier)
- [[#Enspelled (Level 2|Enspelled (Level 2) Revolver]] Revolver)
- [[#Enspelled (Level 2|Enspelled (Level 2) Scimitar]] Scimitar)
- [[#Enspelled (Level 2|Enspelled (Level 2) Semiautomatic Pistol]] Semiautomatic Pistol)
- [[#Enspelled (Level 2|Enspelled (Level 2) Shortbow]] Shortbow)
- [[#Enspelled (Level 2|Enspelled (Level 2) Shortsword]] Shortsword)
- [[#Enspelled (Level 2|Enspelled (Level 2) Shotgun]] Shotgun)
- [[#Enspelled (Level 2|Enspelled (Level 2) Sickle]] Sickle)
- [[#Enspelled (Level 2|Enspelled (Level 2) Sling]] Sling)
- [[#Enspelled (Level 2|Enspelled (Level 2) Spear]] Spear)
- [[#Enspelled (Level 2|Enspelled (Level 2) Staff]] Staff)
- [[#Enspelled (Level 2|Enspelled (Level 2) Trident]] Trident)
- [[#Enspelled (Level 2|Enspelled (Level 2) War Pick]] War Pick)
- [[#Enspelled (Level 2|Enspelled (Level 2) Warhammer]] Warhammer)
- [[#Enspelled (Level 2|Enspelled (Level 2) Whip]] Whip)
- [[#Enspelled (Level 2|Enspelled (Level 2) Wooden Staff]] Wooden Staff)
- [[#Enspelled (Level 2|Enspelled (Level 2) Yklwa]] Yklwa)
