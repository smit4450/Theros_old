...
| 26-30 | You cast [[gust-of-wind-xphb]]. The [[Line (Area of Effect)]] created by the spell extends from you to the chosen point of origin. |
...
| 46-50 | You cast [[lightning-bolt-xphb]]. The [[Line (Area of Effect)]] created by the spell extends from you to the chosen point of origin. |
...
| 93-97 | You cast [[polymorph-xphb]], targeting the creature closest to the chosen point of origin. Roll `1d4` to determine the target's new form. On a **1**, the new form is a [[black-bear-xmm]]; on a **2**, the new form is a [[Giant Wasp]]; on a **3-4**, the new form is a [[Frog]]. |
