...
| dice: 1d100 | Effect |
|-------------|--------|
| 01-20 | You cast a spell originating from the chosen point. Roll `1d10` to determine the spell: on a **1-2**, [[Compendium/spells/Darkness]]; on a **3-4**, [[Faerie Fire]]; on a **5-6**, [[Fireball]]; on a **7-8**, [[Slow]]; on a **9-10**, [[Stinking Cloud]]. |
...
| 26-30 | You cast [[Gust of Wind]]. The [[Line (Area of Effect)]] created by the spell extends from you to the chosen point of origin. |
...
| 46-50 | You cast [[Lightning Bolt]]. The [[Line (Area of Effect)]] created by the spell extends from you to the chosen point of origin. |
...
| 93-97 | You cast [[Polymorph]], targeting the creature closest to the chosen point of origin. Roll `1d4` to determine the target's new form. On a **1**, the new form is a [[black-bear-xmm]]; on a **2**, the new form is a [[Giant Wasp]]; on a **3-4**, the new form is a [[Frog]]. |
...
*Source: Dungeon Master's Guide[Black Bear](Black%20Bear.md)erence Document (5.2)'>SRD</span> and the Free Rules (2024)*