...
One ounce of the glue can cover a 1-foot square surface. Applying an ounce of Sovereign Glue takes a [Utilize](Compendium/rules/actions.md#Utilize) action, and the applied glue takes 1 minute to set. Once it has done so, the bond it creates can be broken only by the application of Universal Solvent or [Oil of Etherealness](Compendium/items/oil-of-etherealness-xdmg.md), or with a [Wish](Compendium/spells/wish-xphb.md) spell.
