...
- **Geyser.** The decanter produces 30 gallons of water that gushes forth in a [[line-area-of-effect-xphb]] 30 feet long and 1 foot wide. If you're holding the decanter, you can aim the geyser in one direction (no action required). One creature of your choice in the [[line-area-of-effect-xphb]] must succeed on a DC 13 Strength saving throw or take `1d4` Bludgeoning damage and have the [Prone](Compendium/rules/conditions.md#Prone) condition. Instead of a creature, you can target one object in the [[line-area-of-effect-xphb]] that isn't being worn or carried and that weighs no more than 200 pounds. The object is knocked over by the geyser.  
