...
As a [Magic](Compendium/rules/actions.md#Magic) action, you can use the weapon to cast [[message-xphb]]. Once this property is used, it can't be used again until the next dawn.
