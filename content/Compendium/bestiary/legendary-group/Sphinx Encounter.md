...
- **Distant Sight.** While in its lair, the sphinx can cast [[clairvoyance-xphb]], requiring no spell components and using the same spellcasting ability as its Spellcasting action. When cast this way, the spell's range is 1 mile.  
