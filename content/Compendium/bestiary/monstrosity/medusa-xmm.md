...
- "desc": "Constitution Saving Throw: DC 13, each creature in a 30-foot [Cone [Area\
    ...
    \ the medusa sees its reflection in the [Cone [Area of Effect]](Compendium/rules/variant-rules/cone-area-of-effect-xphb.md),\
    \ the medusa must make this save. {@actSaveFail 1} The target has the [Restrained](Compendium/rules/conditions.md#Restrained)\
