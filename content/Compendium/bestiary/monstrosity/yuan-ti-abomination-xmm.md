...
- "desc": "Strength Saving Throw: DC 15, one Large or smaller creature within 5\
    \ feet. Failure: 28 (7d6 + 4) Bludgeoning damage. The target has the [Grappled](Compendium/rules/conditions.md#Grappled)\
...
- "desc": "Constitution Saving Throw: DC 14, each creature in a 30-foot [Cone [Area\
    ...
    \ 21 (6d6) Poison damage, and the target has the [Poisoned](Compendium/rules/conditions.md#Poisoned)\
