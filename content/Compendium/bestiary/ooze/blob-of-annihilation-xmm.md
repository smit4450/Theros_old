...
- "desc": "The blob moves up to its [Speed](Compendium/rules/variant-rules/speed-xphb.md)\
    ...
    \ a target has [Cover](Compendium/rules/variant-rules/cover-xphb.md) against attacks\
    \ and other effects outside the blob, and when the blob moves, the engulfed target\
    \ moves with it. A nonmagical object is destroyed after spending 1 minute engulfed.\n\
    \nWhile engulfed, a creature takes 21 (6d6) Force damage at the start of each\
    \ of its turns, is suffocating, has the [Restrained](Compendium/rules/conditions.md#Restrained)\
