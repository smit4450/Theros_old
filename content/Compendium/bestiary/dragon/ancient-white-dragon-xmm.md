...
![](Compendium/bestiary/dragon/img/ancient-white-dragon.webp#right)  
...
- "desc": "Constitution Saving Throw: DC 20, each creature in a 30-foot-radius [Sphere\
    ...
    \ Cold damage, and the target's [Speed](Compendium/rules/variant-rules/speed-xphb.md)\
...
- "desc": "- Frigid Cold. The area within 1 mile of the lair is an area of [extreme\
    ...
    \ Gloom. The area within 1 mile of the lair is [Lightly Obscured](Compendium/rules/variant-rules/lightly-obscured-xphb.md)\
    ...
    \ have its [Speed](Compendium/rules/variant-rules/speed-xphb.md) reduced by 10\
    \ feet for 1 hour.  "
  "name": ""
