...
- "desc": "The beholder randomly shoots one of the following magical rays at a target\
    ...
    \ [Charmed](Compendium/rules/conditions.md#Charmed) condition for 1 hour or until\
    \ it takes damage. Success: Half damage only.  \n- 2 Paralyzing Ray. Constitution\
    \ Saving Throw: DC 16. Failure: The target has the [Paralyzed](Compendium/rules/conditions.md#Paralyzed)\
    ...
    \ start of the beholder's next turn or until the beholder has the [Incapacitated](Compendium/rules/conditions.md#Incapacitated)\
    ...
    \ or an Undead). Failure: The target has the [Unconscious](Compendium/rules/conditions.md#Unconscious)\
    ...
    \ Constitution Saving Throw: DC 16. {@actSaveFail 1} The target has the [Restrained](Compendium/rules/conditions.md#Restrained)\
...
- "desc": "The beholder's central eye emits an antimagic wave in a 150-foot [Cone\
    \ [Area of Effect]](Compendium/rules/variant-rules/cone-area-of-effect-xphb.md).\
...
- "desc": "- Scopophobia. Creatures within 1 mile of the lair feel as if they're\
    ...
    \ a [Short Rest](Compendium/rules/variant-rules/short-rest-xphb.md) while within\
    ...
    \ makes a [D20 Test](Compendium/rules/variant-rules/d20-test-xphb.md) and rolls\
    \ a 1 has the [Prone](Compendium/rules/conditions.md#Prone) condition.  "
  "name": ""
