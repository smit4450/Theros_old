...
![](Compendium/bestiary/aberration/img/aboleth.webp#right)  
## Aboleth
...
- "desc": "If destroyed, the aboleth gains a new body in 5d10 days, reviving with\
    \ all its [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md) in the\
...
- "desc": "While underwater, the aboleth is surrounded by mucus. Constitution Saving\
    \ Throw: DC 14, each creature in a 5-foot [Emanation [Area of Effect]](Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    \ target can breathe air and water, and it can't regain [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "- Foul Water. Water sources within 1 mile of the lair are supernaturally\
    ...
    \ must succeed on a DC 15 Constitution saving throw or have the [Poisoned](Compendium/rules/conditions.md#Poisoned)\
