...
![](Compendium/bestiary/aberration/img/flumph.webp#right)  
## Flumph
...
- "desc": "Dexterity Saving Throw: DC 10, one creature the flumph can see within\
    ...
    \ stench for 1d4 hours, and has the [Poisoned](Compendium/rules/conditions.md#Poisoned)\
    \ condition while the stench lasts. Other creatures have the [Poisoned](Compendium/rules/conditions.md#Poisoned)\
    \ condition while in a 5-foot [Emanation [Area of Effect]](Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    \ originating from the coated target. The target can remove the stench on itself\
    \ if it bathes during a [Short Rest](Compendium/rules/variant-rules/short-rest-xphb.md)\
