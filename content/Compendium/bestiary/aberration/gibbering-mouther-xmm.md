...
"cr": "2"
"traits":
- "desc": "The ground in a 10-foot [Emanation [Area of Effect]](Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "The mouther babbles incoherently while it doesn't have the [Incapacitated](Compendium/rules/conditions.md#Incapacitated)\
    ...
    \ does nothing.  \n- 5-6. The target takes no action or [Bonus Action](Compendium/rules/variant-rules/bonus-action-xphb.md)\
...
- "desc": "Melee Attack: +2, reach 5 ft. Hit: 7 (2d6) Piercing damage. If\
    \ the target is a Medium or smaller creature, it has the [Prone](Compendium/rules/conditions.md#Prone)\
