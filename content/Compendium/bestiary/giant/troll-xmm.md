...
"cr": "5"
"traits":
- "desc": "If the troll ends any turn [Bloodied](Compendium/rules/variant-rules/bloodied-xphb.md)\
    ...
    \ regains [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)."
