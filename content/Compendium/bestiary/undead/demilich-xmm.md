...
![](Compendium/bestiary/undead/img/demilich.webp#right)  
## Demilich
...
- "desc": "Constitution Saving Throw: DC 19, one creature the demilich can see within\
    \ 120 feet. Failure: The target's [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "- Enervating Domain. Whenever a creature other than the demilich or\
    \ one of its allies finishes a [Long Rest](Compendium/rules/variant-rules/long-rest-xphb.md)\
    \ within 1 mile of the lair, the creature must succeed on a DC 20 Constitution\
    \ saving throw or have its [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
    \ maximum reduced by 1d4. This reduction lasts until the creature finishes a\
    \ [Long Rest](Compendium/rules/variant-rules/long-rest-xphb.md) outside that area.\
