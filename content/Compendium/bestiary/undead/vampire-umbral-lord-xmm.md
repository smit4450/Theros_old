...
- "desc": "If the vampire drops to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ its resting place, it has the [Paralyzed](Compendium/rules/conditions.md#Paralyzed)\
    \ condition for 1 hour, after which it regains 1 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)."
  "name": "Shadow Escape"
...
- "desc": "Constitution Saving Throw: DC 18, one creature the vampire can see within\
    ...
    \ [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md) equal to that\
    \ amount."
  "name": "Sanguine Drain"
"legendary_actions":
