...
- "desc": "If the vampire drops to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
    ...
    \ Points](Compendium/rules/variant-rules/hit-points-xphb.md) in mist form, it\
    ...
    \ form and has the [Paralyzed](Compendium/rules/conditions.md#Paralyzed) condition\
    \ until it regains any [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md),\
    \ and it regains 1 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "The vampire has these weaknesses:\n\n- Forbiddance. The vampire can't\
    ...
    \ [Disadvantage](Compendium/rules/variant-rules/disadvantage-xphb.md) on attack\
...
- "desc": "Constitution Saving Throw: DC 17, one creature within 5 feet that is\
    ...
    \ to that amount. A Humanoid reduced to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "If the vampire isn't in sunlight or running water, it shape-shifts into\
    ...
    \ its size and [Speed](Compendium/rules/variant-rules/speed-xphb.md), are unchanged.\n\
    ...
    \ liquid. It has [Resistance](Compendium/rules/variant-rules/resistance-xphb.md)\
...
- "desc": "- Children of the Night. The vampire exerts influence over the animals\
    \ in its domain. From dusk until dawn, Medium or smaller Beasts have the [Charmed](Compendium/rules/conditions.md#Charmed)\
    ...
    \ the lair is [Lightly Obscured](Compendium/rules/variant-rules/lightly-obscured-xphb.md)\
