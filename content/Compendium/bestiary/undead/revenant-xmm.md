...
![](Compendium/bestiary/undead/img/revenant.webp#right)  
...
- "desc": "If the revenant dies, it revives 24 hours later in a different body unless\
    ...
    \ and returns with all its [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)."
...
- "desc": "Wisdom Saving Throw: DC 15, one creature the revenant can see within\
    ...
    \ on itself on a success. After 1 minute, it succeeds automatically. If the [Frightened](Compendium/rules/conditions.md#Frightened)\
    \ target is cursed by the revenant (see Vow of Revenge), the target also has the\
    \ [Paralyzed](Compendium/rules/conditions.md#Paralyzed) condition for the duration."
  "name": "Vengeful Glare"
"bonus_actions":
- "desc": "The revenant curses one creature it can see within 30 feet of itself. The\
    ...
    \ uses this [Bonus Action](Compendium/rules/variant-rules/bonus-action-xphb.md)\
