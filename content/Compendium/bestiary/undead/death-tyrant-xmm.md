...
![](Compendium/bestiary/undead/img/death-tyrant.webp#right)  
## Death Tyrant
...
- "desc": "The death tyrant randomly shoots one of the following magical rays at a\
    ...
    \ the [Charmed](Compendium/rules/conditions.md#Charmed) condition for 1 hour or\
    \ until it takes damage. Success: Half damage only.  \n- 2 Paralyzing Ray.\
    \ Constitution Saving Throw: DC 17. Failure: The target has the [Paralyzed](Compendium/rules/conditions.md#Paralyzed)\
    ...
    \ Reactions; its [Speed](Compendium/rules/variant-rules/speed-xphb.md) is halved;\
    \ and it can take either an action or a [Bonus Action](Compendium/rules/variant-rules/bonus-action-xphb.md)\
    ...
    \ [Incapacitated](Compendium/rules/conditions.md#Incapacitated) condition. The\
    ...
    \ Undead). Failure: The target has the [Unconscious](Compendium/rules/conditions.md#Unconscious)\
    ...
    \ Constitution Saving Throw: DC 17. {@actSaveFail 1} The target has the [Restrained](Compendium/rules/conditions.md#Restrained)\
    ...
    \ force, a 10-foot [Cube [Area of Effect]](Compendium/rules/variant-rules/cube-area-of-effect-xphb.md)\
...
- "desc": "The death tyrant's central eye emits an imperceptible, magical wave of\
    \ negative energy in a 150-foot [Cone [Area of Effect]](Compendium/rules/variant-rules/cone-area-of-effect-xphb.md).\
...
- "desc": "- Negative Energy Suffusion. Whenever a creature within 1 mile of the\
    ...
    \ that finishes a [Short Rest](Compendium/rules/variant-rules/short-rest-xphb.md)\
