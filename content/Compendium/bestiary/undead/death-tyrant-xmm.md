...
"actions":
  ...
  - "desc": "The death tyrant randomly shoots one of the following magical rays at\
      ...
      \ its [Speed](Compendium/rules/variant-rules/speed-xphb.md) is halved; and it\
      \ can take either an action or a [Bonus Action](Compendium/rules/variant-rules/bonus-action-xphb.md)\
