...
- "desc": "Constitution Saving Throw: DC 15, one creature [Charmed](Compendium/rules/conditions.md#Charmed)\
    ...
    \ Half damage. Failure or Success: The target's [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
...
- "desc": "The succubus shape-shifts to resemble a Medium or Small Humanoid or back\
    ...
    \ [Fly Speed](Compendium/rules/variant-rules/fly-speed-xphb.md) is available only\
