...
- "desc": "The arcanaloth has a magic tome. While holding or carrying the tome, the\
    ...
    \ and [Immunity](Compendium/rules/variant-rules/immunity-xphb.md) to Necrotic,\
    ...
    \ a new one when it finishes a [Short Rest](Compendium/rules/variant-rules/short-rest-xphb.md)\
...
- "desc": "Melee Attack: +9, reach 5 ft. Hit: 10 (2d4 + 5) Slashing damage\
    ...
    \ can escape only if the tome is reduced to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)."
