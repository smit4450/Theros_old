...
- "desc": "The pit fiend emanates an aura in a 20-foot [Emanation [Area of Effect]](Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
    ...
    \ aura. Failure: The target has the [Frightened](Compendium/rules/conditions.md#Frightened)\
...
- "desc": "Melee Attack: +14, reach 10 ft. Hit: 18 (3d6 + 8) Piercing damage.\
    ...
    \ condition. While [Poisoned](Compendium/rules/conditions.md#Poisoned), the target\
