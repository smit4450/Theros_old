...
- "desc": "Melee Attack: +5, reach 10 ft. Hit: 8 (1d10 + 3) Slashing damage.\
    ...
    \ [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md) at the start\
    ...
    \ the wound, doing so by succeeding on a DC 12 Wisdom ([Medicine](Compendium/rules/skills.md#Medicine))\
    \ check."
