...
![](Compendium/bestiary/fiend/img/erinyes.webp#right)  
## Erinyes
...
- "desc": "The erinyes has a magic rope. While bearing it, the erinyes can use the\
    ...
    \ to Poison and Psychic damage. The rope turns to dust if reduced to 0 [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md),\
    ...
    \ when finishing a [Short Rest](Compendium/rules/variant-rules/short-rest-xphb.md)\
