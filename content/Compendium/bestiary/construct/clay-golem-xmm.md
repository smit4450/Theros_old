...
- "desc": "Whenever the golem starts its turn [Bloodied](Compendium/rules/variant-rules/bloodied-xphb.md),\
    ...
    \ it continues to be berserk until it is destroyed or it is no longer [Bloodied](Compendium/rules/variant-rules/bloodied-xphb.md)."
  "name": "Berserk"
...
- "desc": "Melee Attack: +9, reach 5 ft. Hit: 10 (1d10 + 5) Bludgeoning damage\
    \ plus 6 (1d12) Acid damage, and the target's [Hit Points](Compendium/rules/variant-rules/hit-points-xphb.md)\
