...
- "desc": "Whenever the golem starts its turn [Bloodied](Compendium/rules/variant-rules/bloodied-xphb.md),\
    ...
    \ it remains so until it is destroyed or it is no longer [Bloodied](Compendium/rules/variant-rules/bloodied-xphb.md).\n\
    ...
    \ it resumes rolling for the Berserk trait again if it is still [Bloodied](Compendium/rules/variant-rules/bloodied-xphb.md)."
  "name": "Berserk"
