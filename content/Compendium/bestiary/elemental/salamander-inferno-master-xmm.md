...
- "desc": "At the end of each of the salamander's turns, each creature of the salamander's\
    \ choice in a 10-foot [Emanation [Area of Effect]](Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
...
- "desc": "The salamander moves up to its [Speed](Compendium/rules/variant-rules/speed-xphb.md)\
    ...
    \ originating from the salamander. When the [Emanation [Area of Effect]](Compendium/rules/variant-rules/emanation-area-of-effect-xphb.md)\
