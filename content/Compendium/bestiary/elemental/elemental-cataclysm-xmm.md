...
![](Compendium/bestiary/elemental/img/elemental-cataclysm.webp#right)  
## Elemental Cataclysm
...
- "desc": "The cataclysm creates one of the following effects at random (roll 1d4):\n\
    ...
    \ 60-foot-radius [Sphere [Area of Effect]](Compendium/rules/variant-rules/sphere-area-of-effect-xphb.md)\
    ...
    \ in a 90-foot [Cone [Area of Effect]](Compendium/rules/variant-rules/cone-area-of-effect-xphb.md).\
    ...
    \ cloud fills a 60-foot-radius [Sphere [Area of Effect]](Compendium/rules/variant-rules/sphere-area-of-effect-xphb.md)\
    ...
    \ in the cloud have the [Blinded](Compendium/rules/conditions.md#Blinded) and\
    \ [Deafened](Compendium/rules/conditions.md#Deafened) conditions and can't cast\
    ...
    \ creature in a 90-foot [Cube [Area of Effect]](Compendium/rules/variant-rules/cube-area-of-effect-xphb.md)\
    ...
    \ condition, has [Cover](Compendium/rules/variant-rules/cover-xphb.md), and is\
    \ suffocating. As an action, a buried creature or another creature within 5 feet\
    \ of it can make a DC 18 Strength ([Athletics](Compendium/rules/skills.md#Athletics))\
...
- "desc": "The cataclysm moves up to its [Speed](Compendium/rules/variant-rules/speed-xphb.md),\
    ...
    \ DC 23. Failure: The target has the [Prone](Compendium/rules/conditions.md#Prone)\
