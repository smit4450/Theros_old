...
- **Equipment.** Choose A or B: (A) [Mace](Compendium/items/mace-xphb.md), [Smith's Tools](Compendium/items/smiths-tools-xphb.md), [Fine Clothes](Compendium/items/fine-clothes-xphb.md), [Manacles](Compendium/items/manacles-xphb.md), [Portable Ram](Compendium/items/portable-ram-xphb.md), 4 GP; or (B) 50 GP  
...
Stratian forces are divided into three types of duty and armed appropriately for the task before them. **Lukos.** are the most elite forces among the stratians.The so-called wolves contend with threats that the Alamon can't handle alone. After the guerrilla tactics of the Alamon have softened up a target, the heavily armored Lukos march to finish the task.  