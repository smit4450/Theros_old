...
As a [Search](Compendium/rules/actions.md#Search) action, a creature can examine the walls and make a DC 15 Wisdom ([Perception](Skills.md#Perception)) check, detecting the holes on a successful check. Plugging all the holes with wax, cloth, or detritus prevents the darts from firing.

As a [Search](Compendium/rules/actions.md#Search) action, a creature can examine the section of floor that forms the pressure plate and make a DC 15 Wisdom ([Perception](Skills.md#Perception)) check, detecting the pressure plate on a successful check. Wedging an [[Iron Spikes]] or a similar object under the pressure plate prevents the trap from triggering.
