...
"Chapter 2" of the "Player's Handbook" offers a [[alignment-and-personality-personality-traits-by-alignment-xphb]] linked to alignment that can inspire you in playing an NPC or another monster in your game.
...
You can alter a creature's size and creature type as you please. For example, you can use an [[ogre-xmm]] stat block for a human bully—just make it a Medium Humanoid instead of a Large Giant.

#### Ability Scores

You can usually change a creature's Intelligence, Wisdom, and Charisma scores freely unless the ability is used for spellcasting. For example, a [[black-pudding-xmm]] stat block could represent a sapient alien if you raise its Intelligence and Charisma to 10 or so. It's usually best to leave its Strength, Dexterity, and Constitution scores alone, as changes to these scores can alter a monster's attack bonus, damage, [[armor-class-xphb]], or [[hit-points-xphb]], which in turn can alter its [[challenge-rating-xphb]].
...
You can freely change the name and flavor of an attack, as well as its damage type. For example, you can turn an ordinary [[skeleton-xmm]] into an ice skeleton that deals Cold damage as it accosts characters with a blade of ice or hurls shards of ice at them.
...
- **Emissary of Juiblex.** When the creature dies, its body disgorges a [[hostile-attitude-xphb]] [[ochre-jelly-xmm]] in the same space.  
...
**Titans** are the creations of deities. They might be manufactured on a divine forge, born from the blood spilled by a god, or otherwise brought about through divine will or substance. Some titans, including [[kraken-xmm]] and the [[tarrasque-xmm]], appear in the "Monster Manual".
...
The "Player's Handbook" describes common hazards that adventurers encounter, such as [[falling-xphb]] and [[dehydration-xphb]]. This section details some more unusual hazards you can add to a location to make it more challenging.
...
For example, if you find the adventurers unexpectedly arguing with a Lawful Neutral guard, you might create a cooperative but laconic guard who is happy to help the adventurers but speaks curtly, hoping to end the conversation as quickly as possible. Or, looking at the [[imp-xmm]] stat block in the "Player's Handbook" and noting its highest ability (Dexterity) and its lowest (Strength), you might decide that the little devil is fidgety and indirect, constantly on the move and talking in circles to get to its point
