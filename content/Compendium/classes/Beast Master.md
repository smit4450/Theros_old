...
In combat, the beast acts during your turn. It can move and use its [[Reaction]] on its own, but the only action it takes is the [Dodge](Compendium/rules/actions.md#Dodge) action unless you take a [[Bonus Action]] to command it to take an action in its stat block or some other action. You can also sacrifice one of your attacks when you take the [Attack](Compendium/rules/actions.md#Attack) action to command the beast to take the Beast's Strike action. If you have the [Incapacitated](Conditions.md#Incapacitated) condition, the beast acts on its own and isn't limited to the [Dodge](Compendium/rules/actions.md#Dodge) action.
