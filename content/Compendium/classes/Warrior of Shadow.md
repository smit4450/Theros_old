...
*Harness Underworld Power for Stealth and Subterfuge*

Warriors of Shadow practice stealth and subterfuge, harnessing the power of the Underworld. They are at home in darkness, able to draw gloom around themselves to hide, leap from shadow to shadow, and take on a wraithlike form.

### Shadow Arts (Level 3)

You have learned to draw on the power of the Underworld, gaining the following benefits.

### Darkness (Level 3)

You can expend 1 Focus Point to cast the [[Compendium/spells/Darkness]] spell without spell components. You can see within the spell's area when you cast it with this feature. While the spell persists, you can move its area of [[Compendium/spells/Darkness]] to a space within 60 feet of yourself at the start of each of your turns.
...
While entirely within [[Dim Light]] or [[Compendium/spells/Darkness]], you can use a [[Bonus Action]] to teleport up to 60 feet to an unoccupied space you can see that is also in [[Dim Light]] or [[Compendium/spells/Darkness]]. You then have [[Advantage]] on the next melee attack you make before the end of the current turn.

### Improved Shadow Step (Level 11)

You can draw on your Underworld connection to empower your teleportation. When you use your Shadow Step, you can expend 1 Focus Point to remove the requirement that you must start and end in [[Dim Light]] or [[Compendium/spells/Darkness]] for that use of the feature. As part of this [[Bonus Action]], you can make an [[Unarmed Strike]] immediately after you teleport.
